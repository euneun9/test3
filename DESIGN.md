...
### Geist Mono    Monospace companion for code blocks, terminal output, package names, and inline technical strings. Tracking stays at normal    mono type is allowed to breathe compared to the display sans 쨌 `--font-geist-mono`
